...
# Normalised (0-1) ROI boxes: (x1, y1, x2, y2). These are illustrative
# starting points for a fairly common layout, not a universal template -
# calibrate them from the sidebar for your own documents.
DEFAULT_ROI = {
    "citizenship": {
        "citizenship_no": (0.48, 0.07, 0.97, 0.15),
        "full_name": (0.34, 0.33, 0.97, 0.41),
        "father_name": (0.34, 0.43, 0.97, 0.51),
        "dob": (0.34, 0.53, 0.97, 0.61),
        "address": (0.34, 0.63, 0.97, 0.80),
    },
    "kyc": {
        "citizenship_no": (0.08, 0.10, 0.55, 0.18),
        "full_name": (0.08, 0.22, 0.92, 0.30),
